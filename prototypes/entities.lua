...
-- {
	...
	-- }
-- }
vehicle_slowdown_projectile.light = nil
...
vehicle_damage_explosion.sound = nil
-- {
	-- aggregation =
	-- {
		-- max_count = 1,
...
local vehicle_damaged_sticker = util.table.deepcopy(data.raw["sticker"]["slowdown-sticker"])

vehicle_damaged_sticker.name = "vehicle-damaged-sticker"
